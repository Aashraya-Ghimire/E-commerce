            ...
            <div className="border-t px-6 py-5 bg-gray-50">
              <div className="flex justify-between items-center text-lg font-semibold text-gray-700 mb-4">
                ...
                <span className="text-orange-500 text-xl">
                  ${dta.reduce((acc, item) => acc + item.caloriesPerServing, 0)}
                </span>
              </div>
              <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-6">
                <button
                  ...
                  className="cursor-pointer flex items-center justify-center w-full sm:w-auto gap-2 px-6 py-3 bg-white border border-gray-300 text-gray-700 font-medium rounded-full shadow hover:bg-gray-100 transition duration-300"
                >
                  <MdDeleteOutline className="text-xl " />
                  Clear Cart
                </button>

                <button className="cursor-pointer flex items-center justify-center w-full sm:w-auto gap-2 px-6 py-3 bg-gradient-to-r from-[#f58021] to-[#f56200] text-white font-semibold rounded-full shadow-md hover:shadow-lg hover:scale-[1.02] transition duration-300">
